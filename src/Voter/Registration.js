    ...
    if (validateCurrentStep()) {
      try {
        ...
        await set(ref(database, `voters/${formData.state}/${formData.district}/${formData.subDistrict}/${formData.village}/${formData.voterNumber}`), {
          ...
          aadhaarNumber: formData.aadhaarNumber, // Add this
                ...
                <FormFields>
                  ...
                  <FormGroup>
                    ...
                    <Input 
                      ...
                      required
                    />
                    {errors.aadhaarNumber && <ErrorMessage>{errors.aadhaarNumber}</ErrorMessage>}
                  </FormGroup>
      ...
      <Container>
        ...
        {showModal && (
          ...
          <ModalContainer>
            ...
            <ModalButton onClick={() => { setShowModal(false); window.location.href = "/voter-dashboard"; }}>
              OK
            </ModalButton>
          </ModalContainer>
        </ModalOverlay>
